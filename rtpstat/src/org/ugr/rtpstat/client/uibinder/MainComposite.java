...
public class MainComposite extends MainCompositeBase {
	...
	public void limpiarPorRol() {
		rtpstatService.currentUserRol(new AsyncCallback<Rol>() {
			...
			public void onFailure(Throwable caught) {
				notificadorGeneral.warning("Problema de comunicación con el servidor. Recargue la página.");
			}
		});
	}

	public static MainUiBinder getUiBinder() {
		return uiBinder;
	}
			...
			case EDITAR_RELACION_EJERCICIOS:
				GWT.runAsync(new RunAsyncCallback() {
					public void onSuccess() {
						...
						//TODO boolean relacionNuevecita = token.indexOf("nueva_") != -1;
