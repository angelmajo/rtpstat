...
public class BackendProxy implements Backend {
	 ...
	 */
	public String solicitarGeneracionRelacion(RelacionEjercicios r)
			throws IOException {
		String out = null;
		if (backends.size() > 1) {
			throw new Error("Demasiados backends disponibles");
	...
	/*
	 * (non-Javadoc)
	 * @see org.ugr.rtpstat.server.backendproxy.Backend#solicitarGeneracionLibro(org.ugr.rtpstat.client.orm.Libro)
	 */
	 ...
	 */
	public EstadoGeneracion getEstado(String token, Class<?> clase)
	 ...
	 * 
	 * @see
	 * org.ugr.rtpstat.server.backendproxy.Backend#getMensajeError(java.lang
	 * .String)
	 */
	...
	protected BackendProxy() {
		try {
			...
			backends.add(new DefaultBackend(new URL(
					"http://jamaldo2.ugr.es:8080/rtpstat-backend/")));
