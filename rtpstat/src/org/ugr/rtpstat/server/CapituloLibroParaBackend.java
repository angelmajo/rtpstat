...
public class CapituloLibroParaBackend extends CapituloLibro {
	...
	private static final long serialVersionUID = 8861308517358162704L;
	...
	public CapituloLibroParaBackend(CapituloLibro capitulo) {
		super(capitulo.getTitulo(), capitulo.getResueltosTitulo(), null, capitulo.getPropuestosTitulo(), null);
	...
	public String toString() {
		...
		for (String archivo : resueltosTokens) {
			sb.append(new File(carpetaRepositorio, archivo).getAbsolutePath() + File.separator + "Problema" + lineSeparator);
		}
		sb.append("    </archivos>" + lineSeparator);
		sb.append("  </resueltos>" + lineSeparator);
	...
	public ArrayList<ResumenProblema> getPropuestos() {
		throw new UnsupportedOperationException("En el backend no pensamos en ResumenProblema, pensamos en tokens...");
	}
