...
public class Problema implements Serializable, IsValidable {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -5076541332730986440L;
	...
	public Problema(String descripcion, GradoDificultad dificultad, String cabecera, String cabeceraSegunda, String[] areasObjetivo, Datos datos,
			Apartado[] apartados) {
		super();
