...
public class RelacionEjercicios implements Serializable {
	private static final long serialVersionUID = 9200170568251363760L;

	public RelacionEjercicios() {
		this(Long.MIN_VALUE, null, null, null, null);
	}

	public RelacionEjercicios(long id, String titulo, TipoRelacion tipo, String[] areasObjetivo, ArrayList<ResumenProblema> problemas) {
		this.id = id;
		this.titulo = titulo;
		this.tipo = tipo;
