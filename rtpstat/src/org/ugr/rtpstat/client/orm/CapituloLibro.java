...
public class CapituloLibro implements IsSerializable {
  private Long id;
  ...
  public CapituloLibro(String titulo, String resueltosTitulo, ArrayList<ResumenProblema> resueltos,
      String propuestosTitulo, ArrayList<ResumenProblema> propuestos) {
    this(Long.MIN_VALUE, titulo, resueltosTitulo, resueltos, propuestosTitulo, propuestos);
  }
